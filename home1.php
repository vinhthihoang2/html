            ...
            <div class="row d-flex stp_cols">
                <div class="col-4">
                    ...
                    <div>
                        ...
                        <div class="ptp_address_1 mt-3">Canbbera - Australian</div>
                        <div class="d-flex align-items-baseline mt-4 pt-3">
                            <div class="stp_price pe-3"><del>$120</del></div>
                            <div class="ptp_price_sale">$90/</div>
                            <div class="ptp_person">Person</div>
                ...
                <div class="col-4">
                    ...
                    <div>
                        ...
                        <div class="ptp_address_1 mt-3">Canbbera - Australian</div>
                        <div class="d-flex align-items-baseline mt-4 pt-3">
                            <div class="stp_price pe-3"><del>$99</del></div>
                            <div class="ptp_price">$75/</div>
                            <div class="ptp_person">Person</div>
                ...
                <div class="col-4">
                    ...
                    <div>
                        ...
                        <div class="ptp_address_1 mt-3">Canbbera - Australian</div>
                        <div class="d-flex align-items-baseline mt-4 pt-3">
                            <div class="stp_price pe-3"><del>$85</del></div>
                            <div class="ptp_price">$65/</div>
                            <div class="ptp_person">Person</div>
        ...
        <div class="container">
            ...
            <div class="row d-flex text-center pb-5">
                <div class="col">
                    ...
                    <div class="header_icon_nav ms-auto py-5">
